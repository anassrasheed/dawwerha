...
abstract class RegisterRepository {
  Future<Either<Failure, GenericResponse>> register(
      String email, String password, String name, String otpToken,
...
class ApiRegisterRepository extends RegisterRepository {
  @override
  Future<Either<Failure, GenericResponse>> register(
      String mobileNumber, String password, String name, String otpToken,
