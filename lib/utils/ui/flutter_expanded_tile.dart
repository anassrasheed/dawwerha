...
// Title
  ...
  final Widget expandedTitle; // required
// Trailing
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
                  ...
                  children: <Widget>[
                    ...
                    Expanded(
                      child: Container(
                        ...
                        child:
                            _isExpanded ? widget.expandedTitle : widget.title,
                      ),
                    ),
                    _isExpanded
                        ? Image.asset('assets/opened_icon.png', width: 5.5.w)
                        : widget.trailing!
                  ],
                ),
              ),
        ...
        SizedBox(
          height: _isExpanded ? widget.contentSeperator : 0,
        ),
        //* Content
        AnimatedSize(
